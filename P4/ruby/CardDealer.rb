...
class CardDealer 
    ...
    def createEnemies() 
        ...
        # @enemies.add(EnemyStarShip.new("Enemigo fácil -1",0,0,goodLoot,NumericDamage.new(0,0)));
        ...
        # @enemies.add(EnemyStarShip.new("Enemigo transforma 0",0,0,Loot.new(1,1,1,0,1,true,false),NumericDamage.new(0,0)))
        @enemies.add(EnemyStarShip.new("Enemigo transforma 0",0,0,Loot.new(1,1,1,0,1,false,true),NumericDamage.new(0,0)))
