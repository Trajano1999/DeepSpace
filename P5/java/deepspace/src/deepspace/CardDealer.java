...
class CardDealer {
    ...
    private void createEnemies() {
        ...
        // Un enemigo muy fácil que transforma
        // enemies.add(new EnemyStarShip("Enemigo transforma 1",0,0,new Loot(1,1,1,0,1,false,true),new NumericDamage(0,0)));
   
        // Un enemigo que provoque un daño específico
        //enemies.add(new EnemyStarShip("Enemigo transforma 1",500,500,new Loot(1,1,1,0,1,false,true),new SpecificDamage(new ArrayList<>(Arrays.asList(WeaponType.LASER,  WeaponType.LASER,WeaponType.LASER,WeaponType.MISSILE,WeaponType.MISSILE,WeaponType.MISSILE,WeaponType.PLASMA,WeaponType.PLASMA,WeaponType.PLASMA)),2)));
  
        // Un enemigo que provoca un daño numérico
        // enemies.add(new EnemyStarShip("Enemigo transforma 1",500,500,new Loot(1,1,1,0,1,false,true),new NumericDamage(2,5)));
    }
}
